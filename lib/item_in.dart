...
class ItemInScreen extends StatefulWidget {
  final List<Contact> suppliers;

  ItemInScreen({Key? key, required this.suppliers}) : super(key: key);

  @override
  _ItemInScreenState createState() => _ItemInScreenState();
}

class _ItemInScreenState extends State<ItemInScreen> {
